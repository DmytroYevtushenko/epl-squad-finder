...
namespace EplSquadFinder.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250131182202_AddDefaultLeagueData")]
    partial class AddDefaultLeagueData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EplSquadFinder.Application.Entities.League", b =>
                {
                    ...
                    b.HasIndex("FootballDataId")
                        .IsUnique()
                        .HasFilter("[FootballDataId] IS NOT NULL");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "PL",
                            LastRefreshed = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Premier League",
                            Season = 2024,
